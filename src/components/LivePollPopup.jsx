          ...
          {poll.options.map((opt, idx) => {
            ...
            return (
              <button
                ...
                disabled={submitted}
                className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl border border-[var(--border-primary)] text-left transition-all font-semibold text-sm cursor-pointer
                  ${submitted
                    ? isSelected
