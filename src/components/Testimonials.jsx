...
const testimonials = [
  {
    ...
    initials: "MV",
    companyColor: "#000000",
    quote: "DMX Academy completely changed how I approach learning. The interactive sandboxes made complex WebGL matrix math click immediately — I went from zero shaders to shipping a custom WebGL renderer in 6 weeks.",
  ...
  },
  {
    ...
    initials: "ER",
    companyColor: "#22c55e",
    quote: "Truly standard-setting curriculum. The blockchain credential I earned from DMX was what got me my interview at Epic — recruiters actually know what it means.",
