...
import {
  ...
  Users, Layers, Brain, FileText, Settings, Calendar, GraduationCap, BookOpen, Gamepad2
} from "lucide-react";
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (!hasAccess) {
        ...
        const name = user?.username || (isMentorSession ? "Eduvantix Mentor" : "Eduvantix Admin");
