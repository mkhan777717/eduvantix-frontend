  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        className="relative z-10 w-full flex flex-col items-center justify-center text-center px-6 pt-28 pb-16 md:pt-32 md:pb-20"
      >
        {/* Badge */}
        <motion.div
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-black tracking-tight leading-[1.05] max-w-4xl mb-5"
        ...
        >
          Deep-dive into modular curricula crafted for modern tech teams.
          Complete code challenges, use interactive sandboxes, and build real projects.
        </motion.p>
